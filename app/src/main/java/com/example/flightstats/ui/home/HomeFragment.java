package com.example.flightstats.ui.home;
...
import com.example.flightstats.GlobalActivity;
...
homeViewModel.getFromCalendarLive().setValue(calendar);
    ...
    private void doSearch()
    {
        ...
        /*FlightListFragment tryz=FlightListFragment.newInstance(begin,end,isArrival,selectedAirport.getIcao());
        FragmentManager manager = getFragmentManager();
        manager.beginTransaction().replace(R.id.drawer_layout,).commit();*/
    }
}